(() => {
  ...
  const changeQty = (id, delta) => {
    ...
    if (element) {
      ...
      const subtotal = element.querySelector(".cart-item-subtotal .value");
      const minusButton = element.querySelector('[data-action="minus"]');
      ...
      if (subtotal) {
        subtotal.textContent = money(item.price * item.qty);
      }
